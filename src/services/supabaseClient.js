 ...
 * CREATE OR REPLACE FUNCTION increment_article_metric(p_target_id TEXT, p_metric_name TEXT, p_user_fingerprint TEXT DEFAULT NULL)
 * RETURNS INTEGER AS $$
 * DECLARE
 *   new_val INTEGER;
 * BEGIN
 ...
 * CREATE OR REPLACE FUNCTION decrement_article_metric(p_target_id TEXT, p_metric_name TEXT, p_user_fingerprint TEXT DEFAULT NULL)
 * RETURNS INTEGER AS $$
 * DECLARE
 *   new_val INTEGER;
 * BEGIN
 *   IF p_metric_name = 'helpful' AND p_user_fingerprint IS NOT NULL THEN
 *     DELETE FROM user_likes WHERE article_id = p_target_id AND user_fingerprint = p_user_fingerprint;
 *   END IF;
 *
